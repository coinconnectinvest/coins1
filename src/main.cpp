...
int64 nChainStartTime = 1376968574;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "08/07/2021 Forkast.News: Ripple expands XRP into NFTs amid escalating legal battles";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xd67a4948d29f46df5ee9514869b3fc7f9b2589c4b231b48357a5418375aa65aa"));
...
unsigned char pchMessageStart[4] = { 0xec, 0x9c, 0xbc, 0x2c };
